#ifndef __PRICES_SCHEDULE__
#define __PRICES_SCHEDULE__
   ...
   /*---------------------------------------------------------------------------------------------------------------*/
    ...
    /*class Path  //bozza
    {
        private:
            ...
            Option_prices **Option_prices_scenario ;  //puntatore a un array di Option Prices (cio� l'evoluzione dei prezzi)
            int length ;
