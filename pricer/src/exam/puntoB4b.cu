...
int main(int argc, char** argv)
{
    ...
    std::string filename = "./data/infile_puntoB4b.txt";
    ...
    filename_output = "./data/puntoB4b.txt";
    std::ofstream fs;
	...
	// B4a
	fs << prcr_args->mc_args.N_simulations << "," << gpu_final_result << "," << gpu_MC_error << "\n";
	...
	// B4a
        fs << prcr_args->mc_args.N_simulations << "," << cpu_final_result << "," << cpu_MC_error << "\n";
