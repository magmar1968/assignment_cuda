...
int main(int argc, char** argv)
{
    ...
    std::string filename = "./data/infile_B4b.txt";
    std::string outfilename  = "./data/outfile_B4b.csv";
    ...
    for (size_t n = MIN_N; n < MAX_N; n+=25){
        

    //     //last_steps
    //     Result* results = new Result[NBLOCKS * TPB];
