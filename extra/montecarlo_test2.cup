...
//test2 per montecarlo: volatilit� = tasso = 0 --> sottostante costante --> prezzo opzione noto
...
int main(int argc, char** argv)
{
    ...
    std::cout << "Prezzo put: " << final_res.opt_price;
    if (final_res.opt_price - 5 < 0.00001)
        return 0;
    else
        return 1;
